...
RESOURCES += src/qt/supra.qrc src/qt/supra_locale.qrc

TRANSLATIONS += src/qt/locale/supra_bg.ts \
                src/qt/locale/supra_de.ts \
                src/qt/locale/supra_en.ts \
                src/qt/locale/supra_es.ts \
                src/qt/locale/supra_fi.ts \
                src/qt/locale/supra_fr.ts \
                src/qt/locale/supra_it.ts \
                src/qt/locale/supra_ja.ts \
                src/qt/locale/supra_pl.ts \
                src/qt/locale/supra_pt.ts \
                src/qt/locale/supra_ru.ts \
                src/qt/locale/supra_sk.ts \
                src/qt/locale/supra_sv.ts \
                src/qt/locale/supra_vi.ts \
                src/qt/locale/supra_zh_CN.ts \
                src/qt/locale/supra_zh_TW.ts
