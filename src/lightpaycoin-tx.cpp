...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Lightpaycoin Core supra-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  supra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded supra transaction") + "\n" +
                               "  supra-tx [options] -create [commands]   " + _("Create hex-encoded supra transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded supra transaction
