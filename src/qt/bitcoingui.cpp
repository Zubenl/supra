                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Supra Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Supra address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and supra: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Supra Core"), this);
    aboutAction->setStatusTip(tr("Show information about Supra Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Supra"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Supra addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Supra addresses"));
    ...
    openAction->setStatusTip(tr("Open a Supra: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Supra Core help message to get a list with possible Supra command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Supra Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Supra network", "", count));
}
...
{
    QString strTitle = tr("Supra Core"); // default title
