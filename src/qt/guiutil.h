...
/** Utility functions used by the Supra Qt UI.
 */
namespace GUIUtil
{
...
// Render Supra addresses in monospace font
...
// Parse "supra:" URI into recipient object, return true on successful parsing
