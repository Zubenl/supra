...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SPR);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeLightpaycoinAmount"))
        SoftSetArg("-anonymizesupraamount", settings.value("nAnonymizeLightpaycoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in supra.cpp during shotdown to also remove the window positions
