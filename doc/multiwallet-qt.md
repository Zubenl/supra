...
In order to support loading of multiple wallets in supra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is supra.cpp.
...
Changes to supra.cpp
----------------------
supra.cpp is the entry point into supra-qt, and as such, will require some minor modifications to provide hooks for
