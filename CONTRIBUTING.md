Contributing to Supra Core
============================

The Supra Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Supra Core project, and is not to be
confused with overall Supra Network Protocol consensus changes.

Whether a pull request is merged into Supra Core rests with the project merge
...
Patches that change Supra consensus rules are considerably more involved than
...
Where a patch set proposes to change the Supra consensus, it must have been
...
The project leader is the release manager for each Supra Core release.
